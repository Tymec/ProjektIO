    ...
    <div>
      ...
      {isGetSubscriberError ? (
        <Message variant="danger">
          {getSubscriberError?.data?.detail || 'Error getting subscriber'}
        </Message>
      ) : isUnsubscribeError ? (
        <Message variant="danger">
          {unsubscribeError?.data?.detail || 'Error unsubscribing'}
        </Message>
      ...
      {id === 'me' && !subscribed ? (
        ...
        <p>
          You are currently subscribed to our newsletter. If you would like to unsubscribe, please{' '}
          <Link onClick={unsubscribeHandler}>click here</Link>.
        </p>
      ) : (
